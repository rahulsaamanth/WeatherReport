...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private void aboutDialog() {
        ...
        String about = "<p>1.3.3</p>" +
                "<p>A lightweight, opensource weather app.</p>" +
                "<p>Developed by <a href='mailto:rahulsaamanthp@gmail.com'>RahulSaamanth Perna</a> and others</p>" +
                "<p>Data provided by <a href='https://openweathermap.org/'>OpenWeatherMap</a>" +
                "<p>Icons are <a href='https://erikflowers.github.io/weather-icons/'>Weather Icons</a>.";
